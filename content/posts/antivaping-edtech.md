---
title: "Building an Interactive Game for Participatory Health Education"
slug: "antivaping-edtech"
date: "2026-04-20"
status: "Public"
type: "Post"
category: ["Portfolio", "Digital"]
tags: ["react", "edtech", "health-education", "product-thinking", "vipp"]
summary: "Designed and built a React-based interactive game for participatory health education, replacing physical materials across 255 school deployments."
thumbnail: null
---

# Building an Interactive Game for Participatory Health Education

**Project Type:** Educational Technology / Health EdTech
**Role:** Designer and developer
**Tech Stack:** React (JSX)
**Deployment Scale:** 255 school deployments across a Malaysian state
...
I designed and built a React-based interactive game that digitized the VIPP activity. Students worked in groups using a 25-sticker system to map chemical effects to organ systems, but now on a screen rather than a poster.
...
The tool went through iterative development alongside the clinical module content. The final version reflected post-Training of Trainers refinements, with the clinical accuracy of the sticker-to-organ mappings validated against the lecture content.

## Why This Piece Matters

This is the "doctor who codes" project. The same person who designed the clinical content also built the technology that delivers it. That's the differentiator. Most health education programs outsource their tech to developers who don't understand the clinical nuances, or rely on clinicians who can't build the tools they envision.
