...
tags: ["react-native", "expo", "firebase", "mobile", "e-commerce", "geolocation"]
summary: "A mobile e-commerce application built with React Native and Expo, featuring geolocation-based services, Firebase backend, and native UI components."
thumbnail: null
---
...
**UI Libraries:** React Native Paper, NativeBase, React Native Elements (RNEUI), Eva Design System (UI Kitten)
**Location:** Expo Location, React Native Community Geolocation, Geolib for distance calculations, Google Places Autocomplete
